// ✅ FULL AdminSchedules.jsx with Delete Schedule Option
...
const AdminSchedules = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Auto start date from selected previous phase
      ...
      setOpen(false);
      setSelectedPhase("");
      setFormData({ phase_name: "", duration: "", start_date: "" });
  ...
  // ✅ DELETE PHASE
  const handleDeletePhase = async (scheduleId) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {schedules.map((phase) => (
          <Card
            ...
            className="relative border-slate-200 rounded-md technical-shadow">
            {/* ✅ Delete Phase Button */}
            <button
              onClick={() => handleDeletePhase(phase.schedule_id)}
